...
object MessageTestWorksheet extends UsersMessageTestFixtures
 ...
 val userJoinResponseMessageJson = JsonParser(user_join_response_Message)
                                                  ...
                                                  //| esult":{"success":true,"message":"Success"},"user":{"foo":"bar","id":"juan-u
                                                  //| ser1","external_id":"juan-ext-user1","name":"Juan Tamad","role":"MODERATOR",
                                                  //| "pin":12345,"welcome_message":"Welcome Juan","logout_url":"http://www.umalis
                                                  //| ka.don","avatar_url":"http://www.mukhamo.com/unggoy"}}}
 ...
 val jsonFoo = foo.toJson                         //> jsonFoo  : spray.json.JsValue = {"header":{"destination":{"to":"apps_channel
                                                  ...
                                                  //| .mukhamo.com/unggoy"}}}
// val jsonFooStr = jsonFoo.convertTo[String]
// val jsonFooVal = jsonFoo.asJson
import spray.json.DefaultJsonProtocol._
 ...
 //val userId = userIdLens.tryGet(jsonFoo)
